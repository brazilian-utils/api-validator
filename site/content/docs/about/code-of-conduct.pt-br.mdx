...
description: As regras de todo espaço do Brazilian Utils, e como relatar um problema.
---

Este Código de Conduta vale para todo repositório da organização [Brazilian Utils](https://github.com/brazilian-utils) e para todo espaço onde se fala do projeto: issues, pull requests, discussions e eventos. Cada biblioteca pode ter a própria cópia. Este é o texto que todas seguem.

Para relatar um problema, escreva para **support@brazilian-utils.com.br**. O relato fica em sigilo.
...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, pelo e-mail support@brazilian-utils.com.br. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
...
Para obter respostas a perguntas comuns sobre este código de conduta, veja a página de Perguntas Frequentes (FAQ) em [https://www.contributor-covenant.org/faq][FAQ]. Traduções estão disponíveis em
