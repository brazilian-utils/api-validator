...
1. Copie `site/fixtures/usage/<lib>/` do repositório docs para `docs/usage/` na biblioteca, ou rode o comando de [Gere os primeiros exemplos](#gere-os-primeiros-exemplos).
