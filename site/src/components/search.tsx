'use client';
// Search in the browser, over the index built with the site (no server).
...
export default function StaticSearchDialog(props: SharedProps) {
  ...
  const { search, setSearch, query } = useDocsSearch({ client: staticClient({ from: `${process.env.NEXT_PUBLIC_BASE ?? ''}/api/search`, locale }) });
  return (
