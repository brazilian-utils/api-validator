...
let registry: IDictionary<string, JsonNode[] -> obj> =
    dict [
        ...
        "legalProcess.removeSymbols", fun a -> box (LegalProcess.removeSymbols (str 0 a))
        ...
        "licensePlate.removeSymbols", fun a -> box (LicensePlate.removeSymbols (str 0 a))
        ...
        "pis.removeSymbols", fun a -> box (Pis.removeSymbols (str 0 a))
